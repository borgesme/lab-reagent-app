# 技术债 / 待优化事项 Backlog（P8c 收尾后）

> **本文档不是 executable plan**，而是 P8c 收尾（HEAD `8d52ccc`，tag `p8c-complete` @ `d491919`）回顾后整理的待优化清单。每条独立可挑选，挑中后建议另起一份 `YYYY-MM-DD-<scope>.md` 计划文件再实施。
